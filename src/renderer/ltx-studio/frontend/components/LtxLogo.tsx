// Brand mark for Kolbo Video Studio.
//
// Originally LTX's wordmark. Replaced with the Kolbo "K" glyph (the same
// inline SVG used in kolbo-desktop's main webapp tab in src/renderer/index.html).
// If kolbo-desktop passes a brandLogoUrl via postMessage (whitelabel build),
// that image is used instead of the inline glyph.
//
// File kept named LtxLogo / LtxLogoProps so existing imports (Home.tsx,
// Project.tsx) keep working without churn — the surface is purely visual.

import { useKolboBrand } from '../hooks/use-kolbo-brand'
