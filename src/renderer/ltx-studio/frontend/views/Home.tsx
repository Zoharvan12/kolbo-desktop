...
function BrandHeader() {
  ...
  return (
    <div className="relative h-72 overflow-hidden bg-gradient-to-br from-indigo-900 via-fuchsia-900 to-rose-900">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(255,255,255,0.15),transparent_60%)]" />
      <div className="absolute bottom-6 left-8 z-10 flex items-center gap-4">
        {brand.logoUrl ? (
          <img src={brand.logoUrl} alt={brand.name} className="h-12 w-12 rounded-lg shadow-lg" />
        ) : null}
        <div>
          <h1 className="text-3xl font-bold text-white drop-shadow-lg">{brand.name} Video Studio</h1>
  ...
  return (
    <div className="h-screen bg-background flex">
      ...
      <main className="flex-1 overflow-auto">
        {/* Header Banner — dynamic brand, gradient background (no hero video to ship) */}
        <BrandHeader />
